...
| B.S. in Science and Technology (2023) and Computer Engineering (2026) from UFRN, Brazil . He is currently an M.Sc. student in Electrical and Computer Engineering at UFRN. Research focuses on AI, LLMs, intelligent agents, and software engineering. | Ph.D. in Mechanical Engineering (USP, 2017) and M.Sc. in Automatic Engineering . He is a researcher at MCTI/CETENE specializing in scientific computing. Research focuses on emerging AI technologies, LLMs, applied data science, and signal analysis. | Ph.D. in Automation (Unicamp, 1999) and Full Professor of Computer Engineering at UFRN. He has over 20 years of R&D experience in industrial software. Research focuses on data science, machine learning, and evolving systems for industrial applications. |
